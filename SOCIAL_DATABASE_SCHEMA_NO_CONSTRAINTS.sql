-- Social Media Tables Schema for InstaLinkr+ - NO CONSTRAINTS VERSION
-- Run this in your Supabase SQL Editor
-- This version removes all foreign key constraints to avoid dependency issues
...
-- Step 4: Create swipes table (NO foreign keys)
...
-- Step 7: Create matches table (NO foreign keys)
...
-- Step 10: Create messages table (NO foreign keys)
...
-- Step 13: Create creator_earnings table (NO foreign keys)
...
-- Step 16: Create content_monetization table (NO foreign keys)
...
-- Step 19: Create creator_subscriptions table (NO foreign keys)
...
-- Step 22: Create instagram_posts table (NO foreign keys)
...
-- Step 25: Create live_streams table (NO foreign keys)
