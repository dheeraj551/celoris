-- Social Media Tables Schema for InstaLinkr+ - FINAL VERSION
-- Run this in your Supabase SQL Editor
-- This version handles existing policies safely by dropping them first

-- Drop existing policies if they exist (for clean start)
