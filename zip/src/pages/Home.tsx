    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/register" className="bg-white text-indigo-600 px-8 py-4 rounded-xl font-bold hover:bg-indigo-50 transition-colors flex items-center justify-center whitespace-nowrap text-lg shadow-lg">
                Start Teaching for Free
              </Link>
              <Link to="/features" className="bg-indigo-800/50 text-white border border-indigo-400/30 px-8 py-4 rounded-xl font-medium hover:bg-indigo-800 transition-colors flex items-center justify-center whitespace-nowrap text-lg backdrop-blur-sm">
                View Features
              </Link>
            </div>
            
            <div className="mt-8 flex flex-wrap items-center gap-6 text-sm text-indigo-200">
      ...
      <section className="py-24 bg-indigo-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/register" className="bg-white text-indigo-600 px-8 py-4 rounded-xl font-bold hover:bg-indigo-50 transition-colors inline-flex items-center gap-2 text-lg">
            Create Your Trainer Profile <ArrowRight className="h-5 w-5" />
          </Link>
          <p className="mt-6 text-indigo-200 text-sm">Takes less than 2 minutes to set up. No credit card required.</p>
        </div>
      </section>
    </div>
  );
