      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <div className="p-2 bg-indigo-50 rounded-lg"><MessageSquare className="h-6 w-6 text-indigo-600" /></div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
          <div className="flex justify-between items-start mb-4">
            <div className="p-2 bg-blue-50 rounded-lg"><DollarSign className="h-6 w-6 text-blue-600" /></div>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="p-6 flex items-center justify-between hover:bg-gray-50 transition-colors">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button className="bg-indigo-50 text-indigo-600 px-3 py-1.5 rounded-lg text-xs font-medium hover:bg-indigo-100">
                    Reply
                  </button>
                </div>
              </div>
          ...
          <div className="p-6 space-y-6">
            <div className="flex gap-4">
              ...
              <div className="flex-1 bg-indigo-50 p-3 rounded-xl border border-indigo-100">
                <h4 className="text-sm font-bold text-indigo-900">1:1 Excel Mentoring</h4>
                <p className="text-xs text-indigo-700 mt-1">with Rahul Sharma</p>
              </div>
            </div>
