          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="rating" className="text-indigo-600 focus:ring-indigo-500" defaultChecked />
        ...
        <div className="flex-1">
              ...
              <div key={trainer.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <Link to={`/trainers/${trainer.id}`} className="text-xl font-bold text-gray-900 hover:text-indigo-600 transition-colors">
                        {trainer.name}
                      </Link>
                      <p className="text-indigo-600 font-medium">{trainer.subject}</p>
                    </div>
                  ...
                  <div className="mt-auto flex gap-3">
                    <Link to={`/trainers/${trainer.id}`} className="flex-1 bg-white border border-indigo-600 text-indigo-600 text-center py-2.5 rounded-xl font-medium hover:bg-indigo-50 transition-colors">
                      View Profile
                    </Link>
                    <button className="flex-1 bg-indigo-600 text-white text-center py-2.5 rounded-xl font-medium hover:bg-indigo-700 transition-colors">
                      Book Demo
                    </button>
                  </div>
                </div>
          ...
          <div className="mt-10 flex justify-center">
            <nav className="flex items-center gap-2">
              ...
              <button className="w-10 h-10 rounded-lg bg-indigo-600 text-white font-medium">1</button>
