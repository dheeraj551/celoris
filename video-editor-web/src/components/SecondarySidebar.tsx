...
export default function SecondarySidebar({ activeTab, setVideoSrc, setVideoName, setDuration, setClips, currentTime = 0, selectedClipId }: SecondarySidebarProps) {
    ...
    switch (activeTab) {
      ...
      case 'transitions':
        return (
          <div className="p-4 flex flex-col gap-4">
            {!selectedClipId && (
              <div className="bg-white/5 border border-white/10 rounded-lg p-3 text-xs text-gray-400 text-center">
