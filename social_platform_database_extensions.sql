...
SELECT 
  ...
  (SELECT created_at FROM messages WHERE match_id = m.id ORDER BY created_at DESC LIMIT 1) as last_message_created_at,
...
-- 14. VPS Video Storage Tables (REMOVED)
-- These tables have been removed in favor of link-based posts.
-- See remove_vps_and_update_posts.sql for migration.