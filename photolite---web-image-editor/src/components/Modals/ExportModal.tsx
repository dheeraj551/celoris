...
import { Download, X, FileImage, Layers, ShieldCheck } from 'lucide-react';
...
export const ExportModal: React.FC<ExportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="w-full max-w-2xl rounded border border-black bg-[#2b2b2b] p-5 shadow-2xl text-gray-300">
