  ...
  return (
    ...
    >
      <div
        ...
        className="flex h-[90vh] max-h-[850px] w-full max-w-5xl flex-col rounded-lg border border-neutral-700 bg-[#222222] shadow-2xl text-gray-200 overflow-hidden"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-black bg-[#282828] px-5 py-3.5 shrink-0">
          <div className="flex items-center gap-2.5">
            <div className="flex h-7 w-7 items-center justify-center rounded bg-gradient-to-tr from-cyan-600 to-blue-500 text-white shadow-md">
              <LayoutTemplate className="h-4 w-4" />
            </div>
            <div>
              <h2 className="text-sm font-bold text-white flex items-center gap-2">
                Canva-Style Design Templates
                <span className="rounded bg-cyan-950/80 px-2 py-0.5 text-[10px] font-mono text-cyan-400 border border-cyan-500/40">
          ...
          <button
            ...
            onClick={onClose}
            className="rounded p-1 text-gray-400 hover:bg-[#383838] hover:text-white transition-colors cursor-pointer"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        {confirmReplace && selectedTemplate && (
          <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70 p-4">
            <div className="w-full max-w-sm rounded border border-neutral-700 bg-[#282828] p-4 text-gray-200 shadow-2xl">
