...
export const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <aside
      ...
      className="flex w-64 flex-col border-l border-black bg-[#2b2b2b] select-none z-30 shrink-0 h-full"
    >
      {/* Top Tabs */}
      <div className="flex border-b border-black bg-[#1a1a1a] text-[11px]">
        <button
          id="tab-layers-btn"
          onClick={() => handleSelectTab('layers')}
          className={`flex flex-1 items-center justify-center gap-1.5 py-1.5 font-medium transition-colors border-b-2 cursor-pointer ${
            activeTab === 'layers'
