...
// sibling layout.tsx, same pattern as app/digital-marketing-course-noida.
//
// This page is the Delhi counterpart to digital-marketing-course-noida.
// Celoris's real, operating address is Sector 62, Noida — there is no
// physical Delhi office and no confirmed home-visit capability in Delhi, so
// (unlike the Noida page) this page does NOT claim home visits or an
// in-person option. Everything here is scoped to what's actually verified:
// live online delivery, the real ₹50L+ Delhi NCR ad-spend credential, and
// the real course pricing — all fetched and confirmed from the live Noida
// page before this file was written. No testimonials are included, because
// no real Delhi-specific student testimonials exist yet; do not invent any
// — add real ones here if/when they exist.

export default function DigitalMarketingCourseDelhi() {
    const pageData = {
        title: "Digital Marketing Course in Delhi",
        ...
        heroDescription: "100% online batches for Delhi NCR — South Delhi, Pitampura, Laxmi Nagar, Dwarka, and beyond. Book Your FREE Demo Class Today.",
        whatsappNumber: "+91 90847 18101",
        whatsappLink: "https://wa.me/919084718101",
        overview: "Whether you are a fresher looking for your first digital marketing job in Delhi, a working professional switching careers, or a business owner who wants to market their own brand — Celoris digital marketing training is built for you, taught live online from our Noida studio. Our trainers have managed real ad campaigns with combined spends of ₹50L+ across Delhi NCR clients.",
        courseDetails: [
            { label: "Course Name", value: "Digital Marketing Training (Basic to Advanced)" },
            { label: "Location", value: "Delhi NCR — South Delhi, Pitampura, Laxmi Nagar, Dwarka | 100% Online" },
            { label: "Mode", value: "Fully Online via Zoom/Google Meet" },
        ...
        curriculum: [
            ...
            },
            {
                ...
                topics: [
                    "Getting your first digital marketing client in Delhi",
        ...
        whyChooseUs: [
            ...
            "100% online — join live from anywhere in Delhi NCR, zero commute",
        ...
        whoIsItFor: [
            "Freshers from Delhi University, Amity, or other Delhi NCR colleges looking for their first marketing job",
        ...
        areasCovered: [
            "Delhi: South Delhi, Pitampura, Laxmi Nagar, Dwarka — and everywhere in between",
            "Wider NCR: Noida, Greater Noida, Ghaziabad, Gurgaon — all fully online"
        ],
        faq: [
            {
                question: "How much does a digital marketing course cost in Delhi?",
            ...
            {
                question: "Are classes held online or in-person for Delhi students?",
                answer: "Fully online, live via Zoom or Google Meet. Celoris is based in Noida, and Delhi batches run as live sessions with a trainer watching in real time, so there's no commute — you join from wherever you are in Delhi NCR."
            },
            {
                question: "Is digital marketing a good career in 2026?",
                answer: "There's real, verifiable demand for it: Internshala alone was listing 986 open digital marketing roles across Delhi NCR as of mid-September 2026 — a number that moves daily, but a fair sense of the hiring activity in this specific market. Skilled digital marketers, especially those who can run paid ads, are in demand across IT companies, D2C brands, and agencies in Delhi."
            },
            {
                question: "What makes Celoris different from other digital marketing courses in Delhi?",
                answer: "Batches are capped at 5 students with real ad-spend campaign practice, transparent pricing with no hidden fees, and fully live online sessions — built around a deliberately different teaching approach rather than a copy of what every other course already offers."
            },
            {
            ...
            {
                question: "Which institute is best for digital marketing in Delhi?",
                answer: "That depends on whether you want live campaign practice or theory, and whether you're a beginner or already working. Celoris focuses specifically on hands-on practice — you run real Google and Meta ad campaigns during the course, learning from your own live data rather than a case study of someone else's results."
            },
            {
                question: "Is there a free digital marketing course in Delhi?",
                answer: "Celoris's paid tracks start at ₹2,500, but if you want to try the platform first, Celoris's free tools (Video Studio, Image Studio, and AI Explorer) are open with no credit card required. They're not a substitute for the structured course, but they're a genuine way to get a feel for how we teach before you commit."
            }
        ]
    }
        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 py-8 selection:bg-emerald-500/30">
            ...
            <div className="container max-w-7xl mx-auto px-4">
                ...
                <div className="flex items-center space-x-2 text-sm text-slate-400 mb-6 font-medium uppercase tracking-wider italic">
                    ...
                    <span>/</span>
                    <span className="text-slate-100 line-clamp-1 italic">Digital Marketing Course Delhi</span>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <div className="relative group">
                            ...
                            <Card className="relative overflow-hidden border-0 bg-[#0d1321]/40 backdrop-blur-3xl rounded-[2.5rem] shadow-3xl">
                                <div className="aspect-[18.4/9] relative overflow-hidden flex items-center justify-center bg-[#00120d]">
                                    <img
                                        src="/Digitalmarketing_course_in%20delhi.png"
                                        alt="Digital Marketing Course Delhi"
                        ...
                        <section className="space-y-8">
                            <h2 className="text-3xl font-black text-white italic uppercase tracking-tighter flex items-center gap-4">
                                ...
                                Why Learn Digital Marketing from Celoris in Delhi?
                            </h2>
                        ...
                        <section className="space-y-8">
                            <h2 className="text-3xl font-black text-white italic uppercase tracking-tighter flex items-center gap-4">
                                ...
                                What Makes Celoris Different in Delhi?
                            </h2>
                            <p className="text-lg text-slate-400 leading-relaxed font-medium">
                                Batches capped at 5 students with real client ad-spend behind the practice work, pricing published upfront with nothing added later, and fully live online sessions you can join from anywhere in Delhi NCR — that's the actual difference, not a claim about being better than any specific competitor.
                            </p>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {[
                                    { feature: "Transparent Pricing", value: "No hidden fees" },
                                    { feature: "Live Campaign Practice", value: "Real ad spend" },
                                    { feature: "100% Online", value: "Live from Delhi NCR" },
                        ...
                        <section className="space-y-8">
                            <h2 className="text-3xl font-black text-white italic uppercase tracking-tighter flex items-center gap-4">
                                ...
                                Areas We Serve in Delhi NCR (100% Online)
                            </h2>
                        ...
                        <div className="pt-8 border-t border-white/5 flex flex-wrap gap-6 text-[10px] font-black uppercase tracking-[0.2em] italic text-slate-500">
                            <span>Locations:</span>
                            <Link href="/digital-marketing-course-noida" className="hover:text-emerald-400 transition-colors">Noida</Link>
                            <span>Related:</span>
                            ...
                            <Link href="/blog/meta-ads-guide-celoris" className="hover:text-emerald-400 transition-colors">Meta Ads Guide</Link>
                            <Link href="/blog/best-digital-marketing-course-what-actually-works" className="hover:text-emerald-400 transition-colors">What Actually Separates a Good Course</Link>
                            <Link href="/courses/digital-marketing-using-ai-tools" className="hover:text-emerald-400 transition-colors">AI Tools Course</Link>
                            <Link href="/about" className="hover:text-emerald-400 transition-colors">Dheeraj Kushwaha</Link>
                                ...
                                <CardContent className="p-10">
                                    ...
                                    <div className="space-y-6 pt-10 border-t border-white/5">
                                        {[
                                            ...
                                            { icon: Globe, text: "100% Online", color: "text-blue-500" },
