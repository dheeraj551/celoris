                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <section className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {[
                                    { name: "Group Classes", price: "Free", focus: "Beginners, Students", duration: "4 Weeks", topics: "Instagram + Facebook organic, content calendar, basic analytics — 100% Free for Students" },
                        ...
                        <CourseReviews courseKey="social-media-marketing-course-noida" courseTitle={pageData.title} />
