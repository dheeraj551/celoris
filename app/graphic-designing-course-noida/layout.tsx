...
export const metadata: Metadata = {
    title: "Graphic Designing Course in Noida | Celoris — Book Free Demo",
    description: "Learn graphic designing in Noida from expert trainers. Photoshop, Illustrator, InDesign, Canva & more. Online & offline. Free demo available. Book today!",
    alternates: {
        canonical: '/graphic-designing-course-noida',
    },
};
