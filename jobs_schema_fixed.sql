-- ===========================================
-- JOBS MANAGEMENT SYSTEM - FIXED VERSION
-- ===========================================

-- Drop existing jobs table and related objects to ensure clean slate
DROP TABLE IF EXISTS public.jobs CASCADE;
DROP VIEW IF EXISTS public.job_statistics CASCADE;
DROP FUNCTION IF EXISTS update_job_slug() CASCADE;
DROP FUNCTION IF EXISTS set_published_at() CASCADE;
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;
DROP FUNCTION IF EXISTS generate_job_slug(text, text) CASCADE;
