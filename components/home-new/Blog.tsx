...
const VideoCard: React.FC<VideoPostProps> = ({ category, title, views, date, image, duration, author }) => (
    ...
    return (
        <div className="mt-16">
            <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-sm px-4 py-2 bg-slate-100 text-slate-600 rounded-lg hover:bg-slate-200 transition-colors font-medium">
                    Browse Channel
                </button>
            </div>
