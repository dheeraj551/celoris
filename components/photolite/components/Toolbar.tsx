    ...
    >
        ...
        {tools.map((tool) => {
          ...
          return (
            <button
              ...
              className={`group relative flex h-7 w-7 items-center justify-center rounded transition-all active:scale-90 cursor-pointer ${
                isActive
            ...
            >
              ...
              {/* Tooltip on hover */}
              <div className="pointer-events-none absolute left-full ml-2 hidden animate-in fade-in-0 slide-in-from-left-1 duration-150 rounded bg-[#1a1a1a] px-2 py-0.5 text-[10px] font-medium text-gray-200 shadow-xl whitespace-nowrap z-50 group-hover:block border border-black">
      ...
      <div className="relative mt-2 flex flex-col items-center pt-2 border-t border-black w-full">
        ...
        <button
          ...
          className="absolute -top-2 left-1.5 flex h-3 w-3 items-center justify-center rounded-xs border border-black bg-black p-0 hover:scale-110 active:scale-90 transition-transform cursor-pointer"
        >
        ...
        <button
          ...
          className="absolute -top-2 right-1.5 text-gray-400 hover:text-white active:scale-90 transition-transform p-0.5 cursor-pointer"
        >
        ...
        <div className="relative h-8 w-8 mt-1">
          ...
          <div
            ...
            className="absolute bottom-0 right-0 h-5 w-5 cursor-pointer rounded-xs border border-black shadow-sm hover:scale-105 active:scale-95 transition-transform"
          />
          <input
            ref={bgInputRef}
            type="color"
          ...
          <div
            ...
            className="absolute top-0 left-0 h-5 w-5 cursor-pointer rounded-xs border border-black shadow-md hover:scale-105 active:scale-95 transition-transform z-10"
          />
          <input
            ref={fgInputRef}
            type="color"
