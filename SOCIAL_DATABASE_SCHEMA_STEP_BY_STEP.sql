-- Social Media Tables Schema for InstaLinkr+ - STEP BY STEP VERSION
-- Run this in your Supabase SQL Editor
-- This version creates tables step by step with better error handling

-- Step 1: Create the main social_profiles table
